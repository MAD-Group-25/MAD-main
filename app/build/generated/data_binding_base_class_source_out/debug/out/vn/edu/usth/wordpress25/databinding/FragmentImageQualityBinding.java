...
public final class FragmentImageQualityBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentImageQualityBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static FragmentImageQualityBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentImageQualityBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_image_quality, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentImageQualityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentImageQualityBinding((FrameLayout) rootView, radioButton, radioButton2,
