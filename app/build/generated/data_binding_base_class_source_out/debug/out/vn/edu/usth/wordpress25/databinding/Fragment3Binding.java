...
public final class Fragment3Binding implements ViewBinding {
  ...
  private Fragment3Binding(@NonNull ConstraintLayout rootView, @NonNull AppCompatButton button2,
  ...
  public static Fragment3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment3Binding((ConstraintLayout) rootView, button2, textHome, textView);
    }
